...
# cus name
name = Label(two,text="Customer Name : ").grid(row=1,column=0,padx=5,pady=5)
...
var = IntVar()
malebutn = Radiobutton(two,text="Saving",variable=var,value =0).grid(row=3,column=1,padx=5,pady=5)
femalebutn = Radiobutton(two,text="Non Saving",variable=var,value=1).grid(row=3,column=3,padx=5,pady=5)

# amount
amount = Label(two,text="Amount").grid(row=4,column=0,padx=5,pady=5)
no_slider = Scale(two,from_=19, to=100,orient=HORIZONTAL).grid(row=4,column=1,padx=5,pady=5)
