...
# pass name
passname = Label(four,text="Passenger Name :").grid(row=1,column=0,padx=4,pady=4)
...
var = IntVar()
butn1 = Radiobutton(four,text="Delhi",variable=var,value =0).grid(row=3,column=1,padx=4,pady=4)
butn2= Radiobutton(four,text="Mumbai",variable=var,value=1).grid(row=3,column=2,padx=4,pady=4)
des = Label(four,text="Destination ").grid(row=3,column=3,padx=4,pady=4)
var1 = IntVar()
butn1 = Radiobutton(four,text="Chennai",variable=var1,value =0).grid(row=3,column=4,padx=4,pady=4)
butn2= Radiobutton(four,text="kolkata",variable=var1,value=1).grid(row=3,column=5,padx=4,pady=4)
