...
# customer id
cusname = Label(three,text="Employee Name :").grid(row=1,column=0,padx=10,pady=10)
...
# employee type
emmtype = Label(three,text="Employee type").grid(row=3,column=0,padx=10,pady=10)
var = IntVar()
regbutn = Radiobutton(three,text="Regular",variable=var,value =0).grid(row=3,column=1,padx=10,pady=10)
tembutn = Radiobutton(three,text="Temporary",variable=var,value=1).grid(row=3,column=3,padx=10,pady=10)

# salary
sal = Label(three,text="Salary").grid(row=4,column=0,padx=10,pady=10)
salamt= Spinbox(three,from_=19,to=100).grid(row=4,column=1,padx=10,pady=10)
