...
var = IntVar()
malebutn = Radiobutton(one,text="Male",variable=var,value =0).grid(row=3,column=1,padx=2,pady=2)
femalebutn = Radiobutton(one,text="Female",variable=var,value=1).grid(row=3,column=3,padx=2,pady=2)
